  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center w-full h-screen gap-7">
        <h1 className="text-[40px] leading-[25.78px] text-transparent h-12  bg-clip-text bg-gradient-to-r from-[#1864FF] to-[#42AAFF] font-clash font-bold md:text-[40px] md:leading-[30.47px]">
         VickyJay
        </h1>
