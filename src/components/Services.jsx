  ...
  return (
    <section className={`mt-[20px] mx-[30px] lg:mt-[86px] lg:mx-[76px]`}>
      ...
      <div className="flex flex-col mt-[56px] gap-2 lg:mt-[56px] lg:flex lg:flex-wrap lg:flex-shrink-0 lg:justify-center lg:flex-row lg:gap-[24px]">
        <div
          className={`flex flex-col gap-3 flex-nowrap justify-start md:flex md:flex-row md:flex-wrap md:justify-around md:gap-4 lg:flex lg:flex-col lg:gap-[24px]`}
        >
          <div
            className={`bg-[#0A1C20] text-[#FFFFFF99] py-[65px] px-[27px] max-w-[369.808px] h-[240px] lg:py-[100px] lg:px-[49px] lg:w-[641px] lg:h-[416px] shrink-0`}
          >
            <h4
          ...
          <div className="bg-gradient-to-r max-w-[369.808px] lg:w-[642px] to-[#F0FEFF4D] from-[#F0FEFF00] pt-0.5">
            <div
              className={`bg-[#0A1C20] shrink-0 text-[#FFFFFF99] py-[65px] px-[27px] max-w-[369.808px] h-[240px] lg:py-[100px] lg:px-[49px] lg:w-[641px] lg:h-[416px]`}
            >
              <h4
        ...
        {/* second card */}
        <div
          className={`mt-[36px] flex flex-row gap-4 lg:mt-[148px] lg:flex lg:flex-col lg:gap-[24px]`}
        >
